...
_DISTRICT_CANON = [
    ...
    ('г.н.новгород',                'Нижний Новгород'),
    ('границах',                    'Нижний Новгород'),
    ...
    # Районы Нижнего Новгорода → группируем в НН
    ('автозаводск',                 'Нижний Новгород'),
    ('приокск',                     'Нижний Новгород'),
    ('советск',                     'Нижний Новгород'),
    ('канавинск',                   'Нижний Новгород'),
    ('московск',                    'Нижний Новгород'),
    ('ленинск',                     'Нижний Новгород'),
    ('нижегородский р',             'Нижний Новгород'),
    ('сормовск',                    'Нижний Новгород'),
    ('г. бор',                      'Городской округ Бор'),
    ('г.бор',                       'Городской округ Бор'),
    (' бор',                        'Городской округ Бор'),
]

# Паттерны мусорных значений — не район, просто описание предпочтений.
# Такие строки будут отброшены и не попадут на график.
_DISTRICT_NOISE = (
    'км от', 'км)', ' км', 'удаленност', 'пределах', 'черте город',
    'транспортн', 'метро', 'шоссе', 'вблизи', 'около', 'рядом',
    ...
    'судостроит', 'химическ', 'фармацевт', 'агропредприят',
    'доскино', 'носовое', 'кудьма', 'дружный', 'ждановск',
    'вне близости', 'преимуществен',
    'ближе к', 'верхняя часть', 'нижняя часть',
    'поволжье',
)
...
def _normalize_district(raw: str) -> str | None:
    ...
    # если оно длиннее 50 символов, скорее всего это свободный текст
    if len(v) > 50:
        return None

    # Обрезаем артефакты разбивки: «50 км)», «районы)» и т.п.
    # Если строка заканчивается на ')' и не содержит '(' — артефакт split
